...
/* The ring around the icon the arrow keys are pointing at. A desktop is
 * chosen by touching it and needs no cursor, but the CardKB has arrows
 * and they have to be pointing at something visible. */
#define THEME_COLOR_SELECTED                (uint32_t)(0x99FF00)
